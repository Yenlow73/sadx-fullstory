...
VoidFunc(GoToNextStage, 0x414610);
...
FunctionPointer(void, SetNextChaoStage, (SADXChaoStage diffuse), 0x715110);
...
ThiscallFunctionPointer(HRESULT, Direct3D_SetNullTextureStage, (DWORD diffuse), 0x78CB40);
