...
void ev0091_k_leavepastsecond(int state)
{
	...
	case 1:
		...
		EV_CreateObjectFunc(&e104, ev_e104, -37.299999f, -238.0f, 1973.0f, 0, 0, 0);
		...
		EV_SetPos(e104, -1657.0f, -383.0f, 2108.52f);
		...
		EV_CameraTargetObj(1, 30, e104, 0.0f, 12.0f, 0.0f, 0);
		EV_LookObject(player, e104, 0.0f, 0.0f, 0.0f);
		EV_Wait(30);
		EV_ClrAction(e104);
		EV_SetAction(e104, &action_e_run0_e104, &texlist_ev_e104_body, 0.6f, 1, 16);
		EV_SetAng(e104, 0, 0x8000, 0);
		moveObject(e104, -1657.0f, -383.0f, 2108.52f, -1700.0f, -383.0f, 1700.0f, 540);
		EV_Wait(70);
